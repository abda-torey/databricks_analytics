...
# MAGIC %md
# MAGIC ## Cell 4: JSON Schema Definition
...
# MAGIC %md
# MAGIC ## Cell 5: Read Bronze (Streaming)
...
# MAGIC %md
# MAGIC ## Cell 6: Parse JSON and Apply Cleaning
# MAGIC
...
# Cleaning delegated to src/ — null drops, standardisation, derived columns
...
# MAGIC %md
# MAGIC ## Cell 7: Write to Silver (Start Streaming Query)
# MAGIC
